...
map('n', "<A-j>", "<CMD>lua require('Navigator').left()<CR>", opts)
map('n', "<A-l>", "<CMD>lua require('Navigator').up()<CR>", opts)
map('n', "<A-;>", "<CMD>lua require('Navigator').right()<CR>", opts)
map('n', "<A-k>", "<CMD>lua require('Navigator').down()<CR>", opts)
